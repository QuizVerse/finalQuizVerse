  ...
  return (
    <div class="flex min-h-screen">
      <aside class="w-64 p-4 border-r">
        ...
        <nav class="space-y-4">
          <div>
            <h2 class="text-lg font-semibold">나의 이력</h2>
          ...
          <div>
            <h2 class="text-lg font-semibold">나의 클래스</h2>
          </div>
          <div>
            <h2 class="text-lg font-semibold">즐겨찾기</h2>
          </div>
          <div>
            <h2 class="text-lg font-semibold">오답노트</h2>
          </div>
          <div>
            <h2 class="text-lg font-semibold">회원정보</h2>
            <ul class="pl-4 space-y-2">
              <li>회원정보 수정</li>
              <li>회원 탈퇴</li>
            </ul>
      ...
      <main class="flex-1 p-6">
        <div class="flex items-center justify-between mb-6">
          <h1 class="text-2xl font-bold">나의 출제이력</h1>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            />
            <div class="p-6">
              <div class="mb-2 text-sm text-blue-500">캠페인 • 2022.04.27</div>
              <h2 class="mb-2 text-lg font-semibold">2024 정보처리기사 실기</h2>
              <p class="mb-2 text-sm text-muted-foreground">취업 / 자격증</p>
              <p class="mb-2 text-sm text-muted-foreground">
                조회수 311 | 응답수 20 | 섹션수 2
              </p>
              <p class="mb-2 text-sm text-muted-foreground">비공개</p>
