      ...
      <main className="flex-1 p-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            />
            <div className="p-6">
              <p className="text-sm text-blue-500">캠퍼스 · 2022.04.27</p>
              <h2 className="mt-2 text-lg font-semibold">2024 정보처리기사 실기</h2>
              <p className="mt-1 text-sm text-muted-foreground">취업 / 자격증</p>
              <p className="mt-1 text-sm text-muted-foreground">문항수 2</p>
