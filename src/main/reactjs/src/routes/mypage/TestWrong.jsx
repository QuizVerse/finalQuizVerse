    ...
    <div className="flex flex-col items-center w-full min-h-screen bg-gray-100">
      <header className="flex items-center justify-between w-full p-4 bg-white border-b">
        <div className="flex items-center space-x-4">
          ...
          <span className="text-lg font-semibold">4 문항</span>
        </div>
        <h1 className="text-xl font-bold">퀴즈 제목을 넣으면 돼요</h1>
        <button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 h-10 px-4 py-2 bg-yellow-500 text-black">
          나가기 &gt;
        </button>
      </header>
      <main className="flex flex-col items-center w-full p-4 space-y-8">
        <div className="w-full max-w-4xl p-4 bg-white border rounded-md">
          ...
          <p className="mt-2 text-sm text-gray-700">
            문제 설명입니다. 구구절절 길어서 이렇게 길게 보일 예정입니다.
        ...
        <div className="w-full max-w-4xl p-4 bg-white border rounded-md">
          ...
          <div className="mt-4 space-y-2">
            <div className="flex items-center space-x-2">
              <input type="radio" id="option1" name="question2" />
              <label for="option1">답안 1 입니다.</label>
            </div>
            <div className="flex items-center space-x-2">
              <input type="radio" id="option2" name="question2" />
              <label for="option2">답안 2 입니다.</label>
            </div>
            <div className="flex items-center space-x-2">
              <input type="radio" id="option3" name="question2" />
              <label for="option3">답안 3 입니다.</label>
            </div>
          </div>
        </div>
