    ...
    <div class="flex flex-col items-center w-full min-h-screen bg-gray-100">
      <header class="flex items-center justify-between w-full p-4 bg-white border-b">
        <div class="flex items-center space-x-4">
          ...
          <span class="text-lg font-semibold">4 문항</span>
        </div>
        <h1 class="text-xl font-bold">퀴즈 제목을 넣으면 돼요</h1>
        <button class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 h-10 px-4 py-2 bg-yellow-500 text-black">
          나가기 &gt;
        </button>
      </header>
