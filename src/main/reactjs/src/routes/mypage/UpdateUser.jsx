    ...
    <div class="flex">
      ...
      <main class="flex-1 p-8">
        <div class="max-w-md mx-auto">
          <h1 class="mb-6 text-2xl font-bold text-center">회원 정보 수정</h1>
          ...
          <form class="space-y-4">
            ...
            <div class="relative">
              ...
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="absolute right-2 top-2.5 w-5 h-5"
              >
          ...
          <div class="mt-4 space-y-1 text-xs text-red-500">
            <p>* 비밀번호 입력 형식을 맞춰주세요.</p>
            <p class="text-green-500">* 사용 가능한 비밀번호입니다.</p>
            <p>* 비밀번호가 일치합니다.</p>
          </div>
        </div>
      </main>
