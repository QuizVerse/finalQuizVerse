            ...
            <div class="rounded-lg border bg-card text-card-foreground shadow-sm w-full max-w-md" data-v0-t="card">
              ...
              <div class="p-6 space-y-4">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-xs text-muted-foreground">인증 제한 시간: 03:00</p>
                </div>
                <div class="space-y-2">
                  <label
                    class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                  ...
                  <p class="text-xs text-muted-foreground">영문/숫자/특수문자 2가지 이상 조합 (8~20자)</p>
                </div>
                <div class="space-y-2">
                  <label
                    class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                ...
                <div class="space-y-2">
                  <p class="text-xs text-red-500">* 비밀번호 양식 형식을 맞춰주세요.</p>
                  <p class="text-xs text-red-500">* 사용 가능한 비밀번호입니다.</p>
                  <p class="text-xs text-green-500">* 비밀번호가 일치합니다.</p>
                </div>
              </div>
