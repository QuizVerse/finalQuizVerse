  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen">
      <header className="flex items-center justify-between w-full h-16 px-4 border-b shrink-0 md:px-6">
        ...
        <nav className="flex items-center gap-6 text-lg font-medium md:text-sm lg:gap-6">
      ...
      <main className="flex flex-col items-center w-full p-4 md:p-10">
        <h1 className="text-2xl font-bold mb-4">‘정보처리기사’ 검색결과(20)</h1>
        ...
        <div className="flex flex-col w-full max-w-2xl gap-4">
          ...
          >
            ...
            <div className="flex flex-col flex-1 ml-4">
              <h2 className="text-lg font-semibold">화상 스터디 제목</h2>
