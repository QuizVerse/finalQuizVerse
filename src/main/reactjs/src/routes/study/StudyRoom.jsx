...
import { AppBar, Box, Button, IconButton, List, ListItem, ListItemText, TextField, Toolbar, Typography } from "@mui/material";
import {
    ...
    return (
        ...
        <LiveKitRoom> 
            ...
            {!room ? (
                        ...
                        <form
                            ...
                            <div style={{
                                ...
                                <IconButton onClick={toggleMic}>
                                    {isMicOn ? <MicIcon sx={{ fontSize: 100 }} /> : <MicOffIcon sx={{ fontSize: 100}} />}
                                </IconButton>
                                
                                <IconButton onClick={toggleCam} size="large">
                                    {isCamOn ? <VideocamIcon sx={{ fontSize: 100 }} /> : <VideocamOffIcon sx={{ fontSize: 100 }} />}
                                </IconButton>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '0.5fr 1.5fr', height: '100vh' }}>
      {/* 첫 번째 구역 */}
      <div>
        aaaaa
      </div>
      ...
      {/* 두 번째 구역 */}
      <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', paddingRight: '300px' }}>
        <div id="room-header">
