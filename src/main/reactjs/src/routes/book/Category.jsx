...
<div class="min-h-screen">
  <header class="flex items-center justify-between p-4 border-b">
    <h1 class="text-2xl font-bold">QuizVerse</h1>
    <nav class="flex items-center space-x-4">
      ...
      <div class="flex items-center space-x-2">
        <button class="px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded">로그아웃</button>
        <div class="flex items-center space-x-2">
          <svg
  ...
  <main class="p-4">
    ...
    <section>
      <h2 class="mb-4 text-xl font-bold">취업/자격증 문제집 Top 5</h2>
      <div class="grid grid-cols-5 gap-4 mb-8">
        <div class="rounded-lg border bg-card text-card-foreground shadow-sm" data-v0-t="card">
          ...
          <div class="p-6">
            ...
            <h3 class="mb-2 text-lg font-bold">2024 정보처리기사 실기</h3>
            <p class="mb-2 text-sm text-muted-foreground">문제집 / 자격증</p>
            <p class="mb-2 text-sm text-muted-foreground">문제집 2권 / 해설 2권</p>
    ...
    <section>
      <h2 class="mb-4 text-xl font-bold">취업/자격증 문제집</h2>
      <div class="flex items-center justify-between mb-4">
        <div class="flex space-x-2">
          <div
