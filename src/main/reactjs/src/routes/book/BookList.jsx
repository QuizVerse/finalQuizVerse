...
export default function BookList() {
  ...
  <div className="min-h-screen bg-white">
    <header className="flex items-center justify-between p-4 border-b">
      ...
      <div className="flex items-center space-x-4">
        <button className="px-4 py-2 text-blue-600 border border-blue-600 rounded">로그인</button>
        <button className="px-4 py-2 text-white bg-blue-600 rounded">회원가입</button>
      </div>
    </header>
    <main className="p-4">
